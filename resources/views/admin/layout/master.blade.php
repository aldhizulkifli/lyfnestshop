      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <a href="#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="{{ url(Auth::user()->photo) }}" alt="User Avatar" class="img-size-50 mr-3 img-circle">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{ route('home') }}" class="brand-link">
      <img src="{{ asset ('static/dist/img/AdminLTELogo.png') }}"
           ...
           style="opacity: .8">
      <span class="brand-text font-weight-light">Lyfenest</span>
    </a>
...
<!-- FastClick -->
<script src="{{ asset('static/plugins/fastclick/fastclick.js') }}"></script>
<!-- AdminLTE App -->
